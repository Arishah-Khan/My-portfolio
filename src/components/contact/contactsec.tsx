        ...
        <section className="bg-gray-100 py-10">
          ...
          Contact Me
                ...
                <div className="flex justify-center w-1/2 mx-auto py-4 space-x-6">
                    {/* LinkedIn Icon */}
                    <div className="relative flex items-center justify-center w-8 h-8 text-white rounded-full bg-[#0077B5] transition-colors duration-300 group hover:bg-[#005582]">
                    ...
                    {/* Instagram Icon */}
                    <div className="relative flex items-center justify-center w-8 h-8 bg-gradient-to-r from-pink-500 to-yellow-500 text-white rounded-full hover:opacity-80 transition-opacity duration-300 group">
