...
const projects = [
  ...
  },
   {
    ...
    bgColor: "bg-[#94d533]", // Button ka background color
    hoverBgColor: "hover:bg-[#d4eead]", // Button hover color
    textColor: "text-white", // Button text color
  ...
  },
   {
    ...
    bgColor: "bg-[#B80000]", // Button ka background color
    hoverBgColor: "hover:bg-[#ffadad]", // Button hover color
    textColor: "text-white", // Button text color
